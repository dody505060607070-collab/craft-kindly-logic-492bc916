    ...
    <div className="space-y-12">
      <div className="flex items-center justify-between">
        ...
        <AdminHelp
          ...
          intro="الواجب هنا بقى زي الاختبار بالظبط: أسئلة اختيار من متعدد أو صح وغلط، بتتصحّح لوحدها."
          items={[
            { title: "١. اعمل الواجب", body: "من قسم 'الواجبات' اضغط 'إضافة جديد'، وحدّد الكورس والدرس (الفيديو اللي الواجب هيظهر تحته) وموعد التسليم والمدة ودرجة النجاح." },
            ...
            { title: "٤. أسئلة الواجب", body: "من 'منشئ الواجب': اختر الكورس ثم الدرس، حدد نوع الأسئلة (اختيار من متعدد / صح وخطأ / متنوع) وعددها، اضغط 'ولّد الأسئلة'، راجعها واحفظها." },
      ...
      <div>
        <SectionHint title="١. الواجبات">
          العنوان والتعليمات اللي الطالب هيقراها، الكورس، الدرس/الفيديو المرتبط، موعد التسليم، المدة، الدرجة القصوى، ودرجة النجاح %. ارفع ملف الأسئلة (للطالب) وملف الإجابة الصحيحة (سري للـ AI). لازم "منشور = نعم".
        </SectionHint>
        <CrudSection
          table="assignments"
          title="الواجبات"
