...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "المستر" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "منصة المستر | كورسات برمجة وذكاء اصطناعي" },
      { name: "twitter:title", content: "منصة المستر | كورسات برمجة وذكاء اصطناعي" },
      { property: "og:description", content: "كورسات برمجة وذكاء اصطناعي مع الأستاذ المستر — شرح مبسط، فيديوهات منظمة، ومتابعة خطوة بخطوة." },
      { name: "twitter:description", content: "كورسات برمجة وذكاء اصطناعي مع الأستاذ المستر — شرح مبسط، فيديوهات منظمة، ومتابعة خطوة بخطوة." },
